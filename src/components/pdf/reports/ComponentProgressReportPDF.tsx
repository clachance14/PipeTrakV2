/**
 * ComponentProgressReportPDF Component
 *
 * Complete PDF document for component progress report.
 * Supports all 3 dimensions: area, system, test_package.
 *
 * Features:
 ...
 *   reportData={{
 *     rows: [{ name: 'Area A', budget: 100, pctTotal: 85, ... }],
 *     grandTotal: { name: 'Grand Total', budget: 100, pctTotal: 85, ... }
 *   }}
...
import { transformComponentProgressToTableProps, getComponentProgressDimensionLabel } from '@/lib/pdfUtils';
import type { ComponentProgressReportPDFProps } from '@/types/pdf-components';
 ...
 * @param props.reportData - Component progress report data (rows and grand total)
 ...
 */
export function ComponentProgressReportPDF({
  reportData,
  projectName,
  dimension,
  generatedDate,
