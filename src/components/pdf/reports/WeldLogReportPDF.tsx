...
function transformWeldsToTableProps(welds: EnrichedFieldWeld[]) {
  ...
  const columns: TableColumnDefinition[] = [
    ...
    { key: 'drawing', label: 'Drawing', width: '12%', align: 'left', format: 'text' },
    { key: 'welder', label: 'Welder', width: '15%', align: 'left', format: 'text' },
    { key: 'dateWelded', label: 'Date Welded', width: '10%', align: 'left', format: 'text' },
    { key: 'weldType', label: 'Type', width: '6%', align: 'center', format: 'text' },
    { key: 'size', label: 'Size', width: '7%', align: 'center', format: 'text' },
    { key: 'ndeResult', label: 'NDE Result', width: '10%', align: 'center', format: 'text' },
