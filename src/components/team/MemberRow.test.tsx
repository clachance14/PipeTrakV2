...
// Mock useOrganization hook for RemoveMemberDialog
...
describe('MemberRow Component', () => {
  ...
  describe('Display', () => {
    it('should render member name', () => {
      render(<MemberRow member={mockMember} isExpanded={false} onToggle={vi.fn()} organizationId="" currentUserRole="viewer" currentUserId="" />);
    ...
    it('should render "Pending" badge for pending invitations', () => {
      render(<MemberRow invitation={mockPendingInvite} isExpanded={false} onToggle={vi.fn()} organizationId="" currentUserRole="viewer" currentUserId="" />);
  ...
  describe('Accessibility', () => {
    ...
    it('should have aria-expanded=true when expanded', () => {
      render(<MemberRow member={mockMember} isExpanded={true} onToggle={vi.fn()} organizationId="" currentUserRole="viewer" currentUserId="" />);
      const button = screen.getByRole('button', { name: /expand permissions/i });
  ...
  describe('Interaction', () => {
    it('should call onToggle when clicked', async () => {
      ...
      render(<MemberRow member={mockMember} isExpanded={false} onToggle={onToggle} organizationId="" currentUserRole="viewer" currentUserId="" />);
  ...
  describe('Expansion State', () => {
    ...
    it('should show correct permissions for viewer role', () => {
      ...
      render(<MemberRow member={viewerMember} isExpanded={true} onToggle={vi.fn()} organizationId="" currentUserRole="viewer" currentUserId="" />);
  ...
  describe('Edge Cases', () => {
    it('should handle null last_active gracefully', () => {
      ...
      render(<MemberRow member={memberWithoutActivity} isExpanded={false} onToggle={vi.fn()} organizationId="" currentUserRole="viewer" currentUserId="" />);
    ...
    it('should handle very long names', () => {
      ...
      render(<MemberRow member={longNameMember} isExpanded={false} onToggle={vi.fn()} organizationId="" currentUserRole="viewer" currentUserId="" />);
    ...
    it('should handle expired invitations', () => {
      ...
      render(<MemberRow invitation={expiredInvite} isExpanded={false} onToggle={vi.fn()} organizationId="" currentUserRole="viewer" currentUserId="" />);
