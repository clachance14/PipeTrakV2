-- Migration: Add missing budget validations
-- The size inheritance migration removed important validations from the original RPC
-- This adds them back: INVALID_BUDGET, NO_COMPONENTS, ZERO_WEIGHT
