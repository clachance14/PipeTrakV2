-- Migration: Fix manhour budget permission check to use users table
-- This project uses single-org architecture with role stored on users table directly
-- Pattern copied from 00105_debug_rpc_final.sql which is known working
