-- Migration: Single-Organization User Model
-- Feature: 004-plan-the-single
-- Date: 2025-10-07
-- Purpose: Refactor from multi-org to single-org user model
-- Breaking Change: Removes user_organizations table, adds direct organization relationship
...
-- ============================================================================
-- RLS POLICY UPDATES (Drop old policies BEFORE dropping table)
-- ============================================================================

-- Drop ALL policies that reference user_organizations
...
-- Drop the junction table NOW that policies are removed
