-- Migration: Create progress delta RPC functions
-- Feature: 033-timeline-report-filter
-- Purpose: Calculate component and field weld progress delta within a date range, grouped by dimension
--
-- Functions created:
-- 1. get_progress_delta_by_dimension - For component progress reports
-- 2. get_field_weld_delta_by_dimension - For field weld reports

-- ============================================================================
-- FUNCTION 1: get_progress_delta_by_dimension
...
-- ============================================================================
-- FUNCTION 2: get_field_weld_delta_by_dimension
...
BEGIN
  ...
  WITH event_deltas AS (
    ...
    -- Calculate delta per event (0->100 = +1, 100->0 = -1)
    SELECT
      me.component_id,
      me.milestone_name,
      -- Count transitions: complete = +1, rollback = -1
      CASE
