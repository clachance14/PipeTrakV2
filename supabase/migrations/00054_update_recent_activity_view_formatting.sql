-- Migration: Update Recent Activity View with Complete Formatting
-- Feature: 018-activity-feed
-- Description: Implement component identity formatting, milestone action formatting, and drawing display logic
-- Tasks: T010 (component identity), T011 (milestone action), T012 (drawing display)

-- Drop and recreate the view with complete formatting
