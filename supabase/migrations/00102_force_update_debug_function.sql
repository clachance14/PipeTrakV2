-- Migration: Force update RPC function with debug logging
-- Feature: 026-editable-milestone-templates
-- Description: Ensure debug logging is active

-- Drop and recreate function to ensure it gets updated
...
BEGIN
  ...
  -- LOG: Insert debug data (this happens BEFORE any validation or permission checks)
...
'Updates template weights with validation, audit logging, and optional retroactive recalculation. (DEBUG VERSION with forced update)';
