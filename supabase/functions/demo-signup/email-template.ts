...
const EMAIL_CONTENT = {
  ...
  CTA_TEXT: 'Access Your Demo Project →',
 ...
 * - Footer with one-click resend magic link button
 *
 ...
 * @param userEmail - User's email address for the resend link
 ...
 *   'https://example.supabase.co/functions/v1/resend-magic-link',
 *   'jane@example.com'
 * )
...
export function generateDemoEmailHtml(
  ...
  // Build resend magic link URL with email parameter
  const resendMagicLinkUrl = userEmail
    ? `${resendLinkUrl}?email=${encodeURIComponent(userEmail)}`
    : resendLinkUrl
...
<body style="${EMAIL_STYLES.BODY}">
  ...
  <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
    ...
    <p style="${EMAIL_STYLES.FOOTER_TEXT}">
      If you need to access your demo again, click below to get a fresh login link sent to your inbox:
    </p>

    <div style="text-align: center; margin: 20px 0;">
      <a href="${resendMagicLinkUrl}"
         style="${EMAIL_STYLES.SECONDARY_CTA_BUTTON}">
        Send Me a New Login Link
      </a>
    </div>

    <p style="${EMAIL_STYLES.FOOTER_TEXT}; font-size: 12px; color: #9ca3af;">
      (You'll receive a new email in seconds)
    </p>
  </div>
