...
### I. Type Safety First
- [ ] TypeScript strict mode enabled (verify tsconfig.json)
- [ ] No `as` type assertions without justification in Complexity Tracking
- [ ] Path aliases (`@/*`) used for imports
- [ ] Database types will be generated from Supabase schema

### II. Component-Driven Development
- [ ] New UI components follow shadcn/ui patterns (Radix + Tailwind)
...
- [ ] Tests will use Vitest + Testing Library
...
- [ ] Feature has spec.md in specs/###-feature-name/
- [ ] This plan.md follows template structure
- [ ] Tasks.md will be generated by /tasks command
- [ ] Implementation will follow /implement workflow
