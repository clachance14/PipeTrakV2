...
async function investigate() {
  ...
  // Get project templates (override system)
  ...
  // Function to get weight (project first, then system)
  ...
  Object.values(groups).forEach(g => {
    ...
    // Get weight (project first, then system)
    const weight = getWeight(g.component_type, g.milestone_name);
    if (!weight) {
      skippedNoWeight++;
      return;
    }
  ...
  console.log('\n=== MANUAL CALCULATION (with project weights) ===');
